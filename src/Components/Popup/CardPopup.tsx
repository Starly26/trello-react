...
const CardPopup:React.FC <CardPopupProps>= ({name, close, columnName, userName, card, visible, changeDescription, comments, addComment, changeComment, changeName, removeComment}) => {
